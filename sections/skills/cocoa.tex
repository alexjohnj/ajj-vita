...
\item Experienced working in \skill{Swift} and \skill{Objective-C} both
  independently and in mixed environments. I have a solid understanding of
  \skill{object orientated}, \skill{protocol orientated} and \skill{functional
    programming} paradigms and use them where appropriate.
...
\item Extensive knowledge of \skill{Core Data}, its \skill{concurrency} model
  ...
  to profile it using \skill{Instruments} and how to design models for fast,
