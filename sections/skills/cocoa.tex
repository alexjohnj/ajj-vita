...
I have experience of developing an app that talks to a third-party \skill{RESTful
  service}, persists the data using \skill{Core Data}, and synchronises changes
...
experienced with using the \skill{MVC} design pattern as well as variants like
...
of \skill{unit testing} with \skill{XCTest}. In recent projects, I have made
